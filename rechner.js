...
function calcGR() {
  ...
  if (om > 0 && or_ > 0 && nm > 0 && nr > 0) {
    ...
    // Korrekturfaktoren: nur wenn Material/Maschenart ANDERS als Original
    // Originalfaktor als Divisor (neutralisiert), eigener als Multiplikator
    const sfB = sfB_raw * (matF.breite / matOrigF.breite) * masF.breite;
    const sfH = sfH_raw * (matF.hoehe  / matOrigF.hoehe)  * masF.hoehe;
